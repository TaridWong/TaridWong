...
output: 
  flexdashboard::flex_dashboard:
    source_code: "https://github.com/TaridWong/TaridWong/tree/R/SuicideFlexBoard"
...
setwd("D:/Program/Private_project/R_private/Suicide")
getwd()
...
### { .colored }
  ...
  *  For this entry, I tried to reproduce the code for interactive dashboard in R as inspired by [a Kaggle entry of Saba Tavoosi](https://www.kaggle.com/tavoosi/suicide-data-full-interactive-dashboard/report).  
  
  *  R is a very powerful tool for statistical analysis and data exploration. Missing data from 2016 and certain countries were removed for a complete picture of the graph.  
  
  * Also, interactive plot, or even normal plot, is an efficient tool to communicate your findings to non-technical stakeholders.
